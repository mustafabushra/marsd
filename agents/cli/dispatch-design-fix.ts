...
async function dispatchDesignFixTasks() {
  ...
  // PHASE 2 TASK 1: Frontend Engineer - Fix Design Mismatch
  const designFixTask = new TaskBuilder(
    'Frontend: Fix Pixel-Perfect Design Mismatch Across All Pages',
    `Audit all 27 React pages against design-approved.html reference file.
...
Demo: ModalDemo`
  ...
  // PHASE 2 TASK 2: QA Engineer - Design Audit
  const designAuditTask = new TaskBuilder(
    'QA: Pixel-Perfect Design Compliance Audit',
    `Verify all 27 pages match design-approved.html.
