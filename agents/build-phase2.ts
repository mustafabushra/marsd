...
╚════════════════════════════════════════════════════════════════════════════╝
  ...
  // Task 1: Company Search API
  const searchAPI = new TaskBuilder(
    'API: POST /companies/search',
    'Company search endpoint with full-text indexing'
  )
