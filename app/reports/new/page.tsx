      ...
      <Card className="max-w-2xl">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Select
            ...
            options={[
              { value: '5', label: '★★★★★ ممتاز جداً (5 نجوم)' },
              { value: '4', label: '★★★★☆ جيد جداً (4 نجوم)' },
              { value: '3', label: '★★★☆☆ جيد (3 نجوم)' },
              { value: '2', label: '★★☆☆☆ مقبول (نجمتان)' },
              { value: '1', label: '★☆☆☆☆ سيء (نجمة واحدة)' },
            ]}
            required
          />
          ...
          <Textarea
            label="التفاصيل"
            name="description"
            placeholder="شرح مفصل عن تجربتك..."
            rows={6}
            required
          />
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>ملاحظة:</strong> سيتم نشر التقرير بشكل مجهول لحماية خصوصيتك.
            </p>
          </div>
          ...
          <label className="flex items-start gap-2 cursor-pointer">
            ...
            <span className="text-sm text-slate-600">
              أتحمل مسؤولية صحة المعلومات وأوافق على نشرها بشكل مجهول
            </span>
          </label>
